...
import TypesOfKeysTable from "./types_of_keys_table"

export default function TypesOfKeys() {
                        ...
                        <div className="h-96 col-span-1 ">
                            <div className="bg-white  rounded-md">
                                ...
                                <div className="bg-white rounded-md list-none  text-center ">
                                    <li className="py-3 border-b-2  hover:bg-indigo-200"><NavLink to="/types_of_keys/new" className={menuLeftTextClass}> {t('description.new_types_of_keys')} </NavLink></li>
